...
public class GoGoShadowARM : MonoBehaviour {
    ...
    void Update() {
        ...
        updatePositionAndRotationToFollowControllerDistance(gogoPos);
    ...
    void updatePositionAndRotationToFollowControllerDistance(Vector3 gogoPosition)
    {
        ...
        if (ARMOn)
        {
            float scaleFactor = 1 / (3f * Vector3.Distance(trackedObj.transform.position, gogoPosition));
    ...
    Vector3 moveControllerForward() {
        ...
        //{
        //    // scaled down by factor of 10
        //    transform.rotation = Quaternion.Lerp(lastRotation, rot, 0.1f);
        //    transform.position = Vector3.Lerp(lastPosition, pose, 0.1f);
        //    print("On");
        //}
        //else
        //{
